...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nfunction _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }\n\nvar getTabAsync = exports.getTabAsync = function getTabAsync(options) {\n    return new Promise(function (resolve, reject) {\n        try {\n            chrome.tabs.query(options, resolve);\n        } catch (e) {\n            return reject(e);\n        }\n    });\n};\n\n// getTabAsync({ active: true })\n//     .then((a) => { console.log(a) })\n//     .catch((a) => { console.log(\"Error message in catch: \", a) });\n\n\nvar getTabAsyncProofWithPause = exports.getTabAsyncProofWithPause = function getTabAsyncProofWithPause(options) {\n    return new Promise(function (resolve, reject) {\n        try {\n            setTimeout(function () {\n                chrome.tabs.query(options, resolve);\n            }, 5000);\n        } catch (e) {\n            return reject(e);\n        }\n    });\n};\n\n// getTabAsyncProofWithPause({ active: true })\n//     .then((a) => { console.log(a) })\n//     .catch((a) => { console.log(\"Error message in catch: \", a) });\n\n\nvar cTPResolveRejectArguments = exports.cTPResolveRejectArguments = function cTPResolveRejectArguments(callbackBasedFunction, nArguments) {\n    var _arguments = Array.prototype.slice.call(arguments),\n        a = _arguments[0],\n        b = _arguments.slice(1);\n\n    return new Promise(function (resolve, reject) {\n        a.apply(undefined, [resolve, reject].concat(_toConsumableArray(b)));\n    });\n};\n\nvar cTPArgumentResolve = exports.cTPArgumentResolve = function cTPArgumentResolve(callbackBasedFunction, options) {\n    return new Promise(function (resolve, reject) {\n        try {\n            callbackBasedFunction(options, resolve);\n        } catch (e) {\n            return reject(e);\n        }\n    });\n};\n\nvar chromeruntimeOnConnect = exports.chromeruntimeOnConnect = function chromeruntimeOnConnect() {\n    return new Promise(function (resolve, reject) {\n        try {\n            chrome.runtime.onConnect.addListener(resolve);\n        } catch (e) {\n            return reject(e);\n        }\n    });\n};\n\n// export default {\n//     getTabAsync,\n//     cTPResolveRejectArguments,\n//     cTPArgumentResolve,\n//     chromeruntimeOnConnect\n// }\n\n//# sourceURL=webpack:///./src/background/chromePorts/callbackToPromise.js?");
