...
/***/ "./src/background/chromePorts/backgroundPortManagement.js":
/*!****************************************************************!*\
  !*** ./src/background/chromePorts/backgroundPortManagement.js ***!
  \****************************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _actionCreators = __webpack_require__(/*! ../store/actionCreators */ \"./src/background/store/actionCreators.js\");\n\nvar _timings = __webpack_require__(/*! ../../constants/timings */ \"./src/constants/timings.js\");\n\nvar _state = __webpack_require__(/*! ../../shared/utils/state */ \"./src/shared/utils/state.js\");\n\nvar _applicationIds = __webpack_require__(/*! ../../shared/constants/applicationIds */ \"./src/shared/constants/applicationIds.js\");\n\nvar Ids = _interopRequireWildcard(_applicationIds);\n\nvar _actions = __webpack_require__(/*! ../../shared/actions */ \"./src/shared/actions.js\");\n\nvar SA = _interopRequireWildcard(_actions);\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar backgroundPortManagement = function () {\n    function backgroundPortManagement(store) {\n        var _this = this;\n\n        _classCallCheck(this, backgroundPortManagement);\n\n        this.store = store;\n        chrome.runtime.onConnect.addListener(function (port) {\n            _this.onConnectPort(port);\n            _this.onMessagePort(port);\n            _this.onDisconnectPort(port);\n        });\n\n        this.setupCheckConnections();\n        chrome.browserAction.onClicked.addListener(function (tab) {\n            var ports = (0, _state.selectStateSlice)([\"ports\"], _this.store.getState());\n            ports.forEach(function (value, key) {\n                if (value.sender.tab.id === tab.id) {\n                    value.postMessage({\n                        id: tab.id,\n                        content: {\n                            app: Ids.MENU,\n                            visible: true\n                        },\n                        action: SA.SET_APP_VISIBILITY\n                    });\n                }\n            });\n        });\n    }\n\n    _createClass(backgroundPortManagement, [{\n        key: 'setupCheckConnections',\n        value: function setupCheckConnections() {\n            var _this2 = this;\n\n            setTimeout(function () {\n                _this2.checkConnections();\n                _this2.setupCheckConnections();\n            }, _timings.CHECK_STILL_ALIVE_INTERVAL);\n        }\n    }, {\n        key: 'checkConnections',\n        value: function checkConnections() {\n            var currentTime = new Date();\n\n            var _store$getState = this.store.getState(),\n                lastUpdateFromPorts = _store$getState.lastUpdateFromPorts;\n\n            var connectionsToRemove = [];\n            lastUpdateFromPorts.forEach(function (value, key) {\n                if (currentTime - value > _timings.MAXIMUM_DEAD_TIME) {\n                    connectionsToRemove.push(key);\n                }\n            });\n            if (connectionsToRemove.length > 0) {\n                console.log(\"Removing connection due to inactivity\", connectionsToRemove);\n                this.store.dispatch((0, _actionCreators.dispatch_DISCONNECT_PORTS)(connectionsToRemove));\n            }\n        }\n    }, {\n        key: 'onConnectPort',\n        value: function onConnectPort(port) {\n            this.store.dispatch((0, _actionCreators.dispatch_CONNECT_PORT)(port));\n        }\n    }, {\n        key: 'onDisconnectPort',\n        value: function onDisconnectPort(port) {\n            var _this3 = this;\n\n            port.onDisconnect.addListener(function (port) {\n                _this3.store.dispatch((0, _actionCreators.dispatch_DISCONNECT_PORTS)([port.name]));\n            });\n        }\n    }, {\n        key: 'onMessagePort',\n        value: function onMessagePort(port) {\n            var _this4 = this;\n\n            port.onMessage.addListener(function (msg) {\n                _this4.store.dispatch((0, _actionCreators.dispatch_ON_PORT_MESSAGE_ACTION)(port, msg));\n            });\n        }\n    }]);\n\n    return backgroundPortManagement;\n}();\n\nexports.default = backgroundPortManagement;\n\n//# sourceURL=webpack:///./src/background/chromePorts/backgroundPortManagement.js?");

/***/ }),

/***/ "./src/background/store/actionCreators.js":
/*!************************************************!*\
  !*** ./src/background/store/actionCreators.js ***!
  \************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.dispatch_ON_PORT_MESSAGE_ACTION = exports.dispatch_DISCONNECT_PORTS = exports.dispatch_CONNECT_PORT = exports.dispatch_TESTING_TWO = exports.dispatch_TESTING_ONE = undefined;\n\nvar _actions = __webpack_require__(/*! ./actions */ \"./src/background/store/actions.js\");\n\nvar A = _interopRequireWildcard(_actions);\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nvar dispatch_TESTING_ONE = exports.dispatch_TESTING_ONE = function dispatch_TESTING_ONE() {\n    return {\n        type: A.TESTING_ONE,\n        payload: [1]\n    };\n};\n\nvar dispatch_TESTING_TWO = exports.dispatch_TESTING_TWO = function dispatch_TESTING_TWO() {\n    return {\n        type: A.TESTING_TWO,\n        payload: [2]\n    };\n};\n\nvar dispatch_CONNECT_PORT = exports.dispatch_CONNECT_PORT = function dispatch_CONNECT_PORT(port) {\n    return {\n        type: A.CONNECT_PORT,\n        payload: {\n            name: port.name,\n            port: port\n        }\n    };\n};\n\nvar dispatch_DISCONNECT_PORTS = exports.dispatch_DISCONNECT_PORTS = function dispatch_DISCONNECT_PORTS(names) {\n    return {\n        type: A.DISCONNECT_PORTS,\n        payload: {\n            names: names\n        }\n    };\n};\n\nvar dispatch_ON_PORT_MESSAGE_ACTION = exports.dispatch_ON_PORT_MESSAGE_ACTION = function dispatch_ON_PORT_MESSAGE_ACTION(port, msg) {\n    return {\n        type: msg.action,\n        payload: {\n            port: port.name,\n            content: msg.content\n        }\n    };\n};\n\n//# sourceURL=webpack:///./src/background/store/actionCreators.js?");

/***/ }),

/***/ "./src/background/store/actions.js":
/*!*****************************************!*\
  !*** ./src/background/store/actions.js ***!
  \*****************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nvar TESTING_ONE = exports.TESTING_ONE = \"TESTING_ONE\";\nvar TESTING_TWO = exports.TESTING_TWO = \"TESTING_TWO\";\nvar CONNECT_PORT = exports.CONNECT_PORT = \"CONNECT_PORT\";\nvar MESSAGE_PORT = exports.MESSAGE_PORT = \"MESSAGE_PORT\";\nvar DISCONNECT_PORT = exports.DISCONNECT_PORT = \"DISCONNECT_PORT\";\nvar DISCONNECT_PORTS = exports.DISCONNECT_PORTS = \"DISCONNECT_PORTS\";\nvar BROWSER_ACTION_TRIGGERED = exports.BROWSER_ACTION_TRIGGERED = \"BROWSER_ACTION_TRIGGERED\";\n\nexports.default = {\n    TESTING_ONE: TESTING_ONE,\n    TESTING_TWO: TESTING_TWO,\n    CONNECT_PORT: CONNECT_PORT,\n    MESSAGE_PORT: MESSAGE_PORT,\n    DISCONNECT_PORT: DISCONNECT_PORT,\n    DISCONNECT_PORTS: DISCONNECT_PORTS,\n    BROWSER_ACTION_TRIGGERED: BROWSER_ACTION_TRIGGERED\n};\n\n//# sourceURL=webpack:///./src/background/store/actions.js?");

/***/ }),

/***/ "./src/background/store/reducers.js":
/*!******************************************!*\
  !*** ./src/background/store/reducers.js ***!
  \******************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.clipBoard = exports.lastUpdateFromPorts = exports.ports = exports.testing = undefined;\n\nvar _redux = __webpack_require__(/*! redux */ \"./node_modules/redux/es/redux.js\");\n\nvar _actions = __webpack_require__(/*! ./actions */ \"./src/background/store/actions.js\");\n\nvar A = _interopRequireWildcard(_actions);\n\nvar _actions2 = __webpack_require__(/*! ../../shared/actions */ \"./src/shared/actions.js\");\n\nvar SHARED = _interopRequireWildcard(_actions2);\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }\n\nvar testing = exports.testing = function testing() {\n    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [\"a\", \"b\"];\n    var action = arguments[1];\n\n    switch (action.type) {\n        case A.TESTING_ONE:\n            {\n                return action.payload;\n            }\n        case A.TESTING_TWO:\n            {\n                return action.payload;\n            }\n        default:\n            {\n                return state;\n            }\n    }\n};\n\nvar ports = exports.ports = function ports() {\n    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new Map();\n    var action = arguments[1];\n\n    switch (action.type) {\n        case A.CONNECT_PORT:\n            {\n                var newState = new Map(state);\n                newState.set(action.payload.name, action.payload.port);\n                return newState;\n            }\n        case A.DISCONNECT_PORT:\n            {\n                var _newState = new Map(state);\n                _newState.get(action.payload.name).disconnect();\n                _newState.delete(action.payload.name);\n                return _newState;\n            }\n        case A.DISCONNECT_PORTS:\n            {\n                var _newState2 = new Map(state);\n                var _iteratorNormalCompletion = true;\n                var _didIteratorError = false;\n                var _iteratorError = undefined;\n\n                try {\n                    for (var _iterator = action.payload.names[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n                        name = _step.value;\n\n                        _newState2.get(name).disconnect();\n                        _newState2.delete(name);\n                    }\n                } catch (err) {\n                    _didIteratorError = true;\n                    _iteratorError = err;\n                } finally {\n                    try {\n                        if (!_iteratorNormalCompletion && _iterator.return) {\n                            _iterator.return();\n                        }\n                    } finally {\n                        if (_didIteratorError) {\n                            throw _iteratorError;\n                        }\n                    }\n                }\n\n                return _newState2;\n            }\n        default:\n            {\n                return state;\n            }\n    }\n};\nvar lastUpdateFromPorts = exports.lastUpdateFromPorts = function lastUpdateFromPorts() {\n    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new Map();\n    var action = arguments[1];\n\n    switch (action.type) {\n        case A.CONNECT_PORT:\n            {\n                var newState = new Map(state);\n                newState.set(action.payload.name, new Date());\n                return newState;\n            }\n        case SHARED.STILL_ALIVE:\n            {\n                var _newState3 = new Map(state);\n                _newState3.set(action.payload.port, new Date());\n                return _newState3;\n            }\n        case A.DISCONNECT_PORT:\n            {\n                var _newState4 = new Map(state);\n                _newState4.delete(action.payload.name);\n                return _newState4;\n            }\n        case A.DISCONNECT_PORTS:\n            {\n                var _newState5 = new Map(state);\n                var _iteratorNormalCompletion2 = true;\n                var _didIteratorError2 = false;\n                var _iteratorError2 = undefined;\n\n                try {\n                    for (var _iterator2 = action.payload.names[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {\n                        name = _step2.value;\n\n                        _newState5.delete(name);\n                    }\n                } catch (err) {\n                    _didIteratorError2 = true;\n                    _iteratorError2 = err;\n                } finally {\n                    try {\n                        if (!_iteratorNormalCompletion2 && _iterator2.return) {\n                            _iterator2.return();\n                        }\n                    } finally {\n                        if (_didIteratorError2) {\n                            throw _iteratorError2;\n                        }\n                    }\n                }\n\n                return _newState5;\n            }\n        default:\n            {\n                return state;\n            }\n    }\n};\n\nvar clipBoard = exports.clipBoard = function clipBoard() {\n    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];\n    var action = arguments[1];\n\n    switch (action.type) {\n        case SHARED.ADD_CLIPBOARD_ITEM:\n            {\n                var newState = [].concat(_toConsumableArray(state));\n                newState.push(action.payload.content.text);\n                return newState;\n            }\n        default:\n            {\n                return state;\n            }\n    }\n};\n\nexports.default = (0, _redux.combineReducers)({\n    testing: testing,\n    ports: ports,\n    lastUpdateFromPorts: lastUpdateFromPorts,\n    clipBoard: clipBoard\n});\n\n//# sourceURL=webpack:///./src/background/store/reducers.js?");

/***/ }),

/***/ "./src/background/store/store.js":
/*!***************************************!*\
  !*** ./src/background/store/store.js ***!
  \***************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.getTesting = exports.configureStore = undefined;\n\nvar _redux = __webpack_require__(/*! redux */ \"./node_modules/redux/es/redux.js\");\n\nvar _reduxLogger = __webpack_require__(/*! redux-logger */ \"./node_modules/redux-logger/dist/redux-logger.js\");\n\nvar _reduxLogger2 = _interopRequireDefault(_reduxLogger);\n\nvar _reducers = __webpack_require__(/*! ./reducers */ \"./src/background/store/reducers.js\");\n\nvar _reducers2 = _interopRequireDefault(_reducers);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar appliedLogger = (0, _redux.applyMiddleware)(_reduxLogger2.default);\n\nvar rootReducer = function rootReducer(state, action) {\n    if (action.type === 'RESET_APP') {\n        state = {\n            \"testing\": [\"a\", \"b\"]\n        };\n    }\n    return (0, _reducers2.default)(state, action);\n};\n\nvar configureStore = exports.configureStore = function configureStore() {\n    return (0, _redux.createStore)(rootReducer, appliedLogger);\n};\n\nvar getTesting = exports.getTesting = function getTesting(store) {\n    return store.getState().testing;\n};\n\n//# sourceURL=webpack:///./src/background/store/store.js?");

/***/ }),

/***/ "./src/backgroundIndex.js":
/*!********************************!*\
  !*** ./src/backgroundIndex.js ***!
  \********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nvar _store = __webpack_require__(/*! ./background/store/store */ \"./src/background/store/store.js\");\n\nvar _actionCreators = __webpack_require__(/*! ./background/store/actionCreators */ \"./src/background/store/actionCreators.js\");\n\nvar _backgroundPortManagement = __webpack_require__(/*! ./background/chromePorts/backgroundPortManagement */ \"./src/background/chromePorts/backgroundPortManagement.js\");\n\nvar _backgroundPortManagement2 = _interopRequireDefault(_backgroundPortManagement);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar store = (0, _store.configureStore)();\nwindow.store = store;\n\nvar portManager = new _backgroundPortManagement2.default(store);\n\n//# sourceURL=webpack:///./src/backgroundIndex.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar SEND_STILL_ALIVE_INTERVAL = exports.SEND_STILL_ALIVE_INTERVAL = 45000;\nvar CHECK_STILL_ALIVE_INTERVAL = exports.CHECK_STILL_ALIVE_INTERVAL = 45000;\nvar MAXIMUM_DEAD_TIME = exports.MAXIMUM_DEAD_TIME = 60000;\n\n//# sourceURL=webpack:///./src/constants/timings.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nvar TESTING_ONE = exports.TESTING_ONE = \"TESTING_ONE\";\nvar TESTING_TWO = exports.TESTING_TWO = \"TESTING_TWO\";\nvar CONNECT_PORT = exports.CONNECT_PORT = \"CONNECT_PORT\";\nvar MESSAGE_PORT = exports.MESSAGE_PORT = \"MESSAGE_PORT\";\nvar DISCONNECT_PORT = exports.DISCONNECT_PORT = \"DISCONNECT_PORT\";\nvar STILL_ALIVE = exports.STILL_ALIVE = \"STILL_ALIVE\";\nvar TOOLBAR_BUTTON_PRESSED = exports.TOOLBAR_BUTTON_PRESSED = \"TOOLBAR_BUTTON_PRESSED\";\nvar SET_APP_VISIBILITY = exports.SET_APP_VISIBILITY = \"SET_APP_VISIBILITY\";\nvar ADD_CLIPBOARD_ITEM = exports.ADD_CLIPBOARD_ITEM = \"ADD_CLIPBOARD_ITEM\";\n\nexports.default = {\n    TESTING_ONE: TESTING_ONE,\n    TESTING_TWO: TESTING_TWO,\n    CONNECT_PORT: CONNECT_PORT,\n    MESSAGE_PORT: MESSAGE_PORT,\n    DISCONNECT_PORT: DISCONNECT_PORT,\n    STILL_ALIVE: STILL_ALIVE,\n    TOOLBAR_BUTTON_PRESSED: TOOLBAR_BUTTON_PRESSED,\n    SET_APP_VISIBILITY: SET_APP_VISIBILITY,\n    ADD_CLIPBOARD_ITEM: ADD_CLIPBOARD_ITEM\n};\n\n//# sourceURL=webpack:///./src/shared/actions.js?");

/***/ }),

/***/ "./src/shared/constants/applicationIds.js":
/*!************************************************!*\
  !*** ./src/shared/constants/applicationIds.js ***!
  \************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar MENU = exports.MENU = \"MENU\";\nvar INJECT_JAVASCRIPT = exports.INJECT_JAVASCRIPT = \"INJECT_JAVASCRIPT\";\n\n//# sourceURL=webpack:///./src/shared/constants/applicationIds.js?");

/***/ }),

/***/ "./src/shared/utils/state.js":
/*!***********************************!*\
  !*** ./src/shared/utils/state.js ***!
  \***********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\n\n//https://medium.com/javascript-inside/safely-accessing-deeply-nested-values-in-javascript-99bf72a0855a\n// I was going to use a loop and a temp variable, but this one seems to do the same with reduce...so that's what I'll use!\nvar selectStateSlice = exports.selectStateSlice = function selectStateSlice(path, obj) {\n    return path.reduce(function (result, currentProperty) {\n        return result && result[currentProperty] ? result[currentProperty] : null;\n    }, obj);\n};\n\n//# sourceURL=webpack:///./src/shared/utils/state.js?");

/***/ }),

/***/ 0:
/*!*****************************************************!*\
  !*** multi babel-polyfill ./src/backgroundIndex.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! babel-polyfill */\"./node_modules/babel-polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! ./src/backgroundIndex.js */\"./src/backgroundIndex.js\");\n\n\n//# sourceURL=webpack:///multi_babel-polyfill_./src/backgroundIndex.js?");
